...
Nilai pada setiap variabel mengikuti **format dan satuan** yang digunakan pada **dataset asli**.

Beberapa variabel merupakan nilai moneter, sedangkan variabel lainnya berupa frekuensi, rasio, atau jumlah. 
