...
Dashboard ini digunakan untuk mengelompokkan pelanggan kartu kredit
berdasarkan pola penggunaan kartu mereka.

Dengan clustering, pelanggan yang memiliki karakteristik serupa
akan ditempatkan pada kelompok (cluster) yang sama sehingga
perusahaan dapat memahami tipe pelanggan yang dimiliki.

### Manfaat :
- Menemukan pelanggan premium
- Menemukan pelanggan aktif bertransaksi
- Menemukan pelanggan yang jarang menggunakan kartu
...
- INSTALLMENTS_PURCHASES : transaksi cicilan
...
st.info("""
PCA (Principal Component Analysis) digunakan untuk mereduksi banyak variabel
menjadi dua dimensi sehingga hasil clustering dapat divisualisasikan.

Semakin terpisah antar kelompok pada grafik PCA,
semakin baik kualitas pemisahan cluster yang terbentuk.
""")
...
st.info("""
PCA digunakan untuk mereduksi dimensi data sehingga cluster dapat
ditampilkan dalam bentuk dua dimensi sehingga hasil clustering dapat divisualisasikan.


Semakin terpisah antar kelompok pada grafik PCA, 
semakin baik kualitas hasil clustering yang diperoleh.
""")
...
for c in cluster_summary.index:
    ...
    if purchases > cluster_summary["PURCHASES"].mean():
        st.success(
            "Pelanggan pada cluster ini cenderung aktif bertransaksi."
        )

    if credit > cluster_summary["CREDIT_LIMIT"].mean():
        st.info(
            "Cluster ini memiliki kapasitas kredit yang relatif tinggi."
        )
...
# =========================================================
st.warning("""
Bagi pengguna non-teknis, fokuslah pada bagian
'Profil dan Interpretasi Cluster' di bawah,
karena bagian tersebut merangkum karakteristik utama setiap kelompok pelanggan.
""")

st.info("""
Heatmap menunjukkan rata-rata karakteristik setiap cluster.

Warna yang lebih merah menunjukkan nilai yang lebih tinggi,
sedangkan warna yang lebih biru menunjukkan nilai yang lebih rendah.
""")
...
st.header("⚔️ Perbandingan Metode Clustering")
...
st.write("""
- Cluster dengan BALANCE tinggi menunjukkan pelanggan aktif.
- Cluster dengan PURCHASES tinggi menunjukkan intensitas transaksi tinggi.
- Cluster dengan CREDIT_LIMIT tinggi menunjukkan kapasitas kredit besar.
- PCA membantu memvisualisasikan pemisahan cluster dalam 2 dimensi.
...
""")
# =========================================================
# 17. Rekomendasi Bisnis
# =========================================================

st.header("🎯 Rekomendasi Bisnis")

st.write("""
Berdasarkan hasil segmentasi pelanggan:

• Cluster dengan transaksi dan limit kredit tinggi dapat menjadi target program loyalitas.

• Cluster dengan aktivitas rendah dapat diberikan promosi khusus untuk meningkatkan penggunaan kartu.

• Cluster premium dapat ditawarkan produk keuangan eksklusif.

• Segmentasi pelanggan membantu perusahaan membuat strategi pemasaran yang lebih efektif.
""")
# =========================================================
# 18. DOWNLOAD DATA
# =========================================================
...
berdasarkan karakteristik penggunaan kartu.

Hasil clustering dapat membantu perusahaan memahami perilaku pelanggan,
menyusun strategi pemasaran yang lebih tepat sasaran,
serta meningkatkan efektivitas program loyalitas pelanggan.
""")
...
st.write(
    "Dashboard dibuat menggunakan Streamlit dan Scikit-Learn 😄"
)